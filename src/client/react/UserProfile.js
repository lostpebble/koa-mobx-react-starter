	...
	render() {
		...
		return (
			<div className="content-block">
				...
				<div className="extra-info">User information retrieved from API (randomuser.me) and rendered on the server (try view source)</div>
				<div className="extra-info">We can then continue to dynamically retrieve users (using exactly the same code behind the scenes) with the button below</div>
